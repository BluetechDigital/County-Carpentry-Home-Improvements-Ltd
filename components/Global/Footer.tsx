...
const Footer: FC = () => {
	...
	return (
		<>
			<footer className="footer p-0 overflow-hidden bg-primary-default border-t-8 border-accent-default border-solid">
					...
					<div className="flex flex-col lg:flex-row items-center lg:items-start justify-between py-4 gap-16 lg:gap-4">
						...
						>
							<Link
								href="/"
								target="_blank"
								aria-label="County Carpentry & Home Improvements Ltd Website Link"
							>
								<Image
									priority
									width={500}
									...
									src="/img/logos/county-carpentry-home-improvements-ltd-logo-white-transparent.png"
									className="object-contain object-center mx-auto lg:mx-0 w-fit h-[75px] lg:h-[200px]"
								/>
							</Link>
							<Paragraph
								...
								tailwindStyling={
									globalContext?.themesOptionsContent?.textarea
										? "px-4 lg:px-0 max-w-full lg:max-w-lg text-base text-white text-center lg:text-left"
										: "hidden"
								}
							/>
							<Paragraph
								...
								tailwindStyling={
									globalContext?.themesOptionsContent?.businessHours
										? "block px-4 lg:px-0 max-w-full lg:max-w-xl text-base text-white text-center lg:text-left"
										: "hidden"
								}
							/>
						</motion.div>
						<div className="flex flex-col md:flex-row items-center lg:items-start justify-center gap-6 xl:gap-20">
							<div className="flex flex-col px-0">
								<h3 className="hidden lg:block mb-5 text-lg font-semibold tracking-normal text-center text-white uppercase lg:text-left">
									About
								</h3>
								<motion.ul
									initial={initial}
								...
								<div className="flex flex-col items-center lg:items-baseline justify-between">
									...
									>
										...
										>
											...
											<Link
												className="font-medium text-base tracking-wide text-white hover:text-accent-two lg:hover:text-accent-twoTwo hover:border-b-2"
					...
					<div className="lg:container px-4 mx-auto flex flex-col-reverse lg:flex-row items-center justify-between">
						...
						>
							<Paragraph
								...
								tailwindStyling="max-w-full lg:max-w-lg text-white text-tiny text-center lg:text-left"
							/>
							<Link
								className="group lg:inline-block items-center justify-center mt-2 px-1 text-white"
							...
							>
								<span className="flex items-center justify-center lg:justify-left gap-2">
									...
									<Paragraph
										...
										tailwindStyling="w-fit lg:w-full text-tiny text-center lg:text-left group-hover:text-accent-two hover:border-b-2"
									/>
								</span>
							</Link>
						</motion.div>
