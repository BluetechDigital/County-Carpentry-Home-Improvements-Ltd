			...
			>
				...
				>
					<motion.h3
						...
						viewport={{once: true}}
						className="font-bold text-base tracking-wide text-primary-default uppercase"
					>
						Cookie Policy
					</motion.h3>
					<Paragraph
						...
						tailwindStyling="mt-1 mb-2 text-sm text-left text-primary-default"
					/>
					<motion.div
						initial={initial}
						variants={stagger}
					...
					>
						<motion.button
							...
							whileInView={fadeInUp}
							viewport={{once: true}}
							className="inline-block px-6 py-3 mr-2 text-xs leading-none text-white transition-all duration-200 ease-in-out bg-accent-two hover:bg-accent-four"
						>
							Accept Cookies
						</motion.button>
						<motion.button
							...
							whileInView={fadeInUp}
							viewport={{once: true}}
							className="inline-block px-6 py-3 text-xs leading-none text-white bg-accent-three hover:bg-tertiary-dark"
						>
							Refuse Cookies
						</motion.button>
					</motion.div>
