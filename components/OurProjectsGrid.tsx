					...
					>
						<div>
							<motion.h4
								...
								viewport={{once: true}}
								className="max-w-sm mx-auto lg:mx-0 text-center lg:text-left text-base text-accent-two uppercase font-semibold font-Inter"
							>
								{subtitle}
							</motion.h4>
							<motion.h3
						...
						<Paragraph
							content={paragraph}
							tailwindStyling="max-w-full lg:max-w-xl text-primary-default text-base text-center lg:text-left"
						/>
					</motion.div>
					<Pagination
