				...
				<div className="lg:container mx-auto px-0 flex flex-col lg:flex-row items-baseline justify-between gap-8">
					<div className="flex flex-col items-center justify-center lg:items-baseline w-full gap-6">
						...
						>
							...
							<Title
								content={title}
								tailwindStyling="title my-3 max-w-xl mx-auto lg:mx-0 text-primary-default uppercase font-Inter leading-tight text-center lg:text-left text-lg sm:text-xl lg:text-4xl"
							/>
							<Paragraph
								content={paragraph}
								tailwindStyling="mb-3 max-w-xl mx-auto xl:mx-0 text-primary-default text-paragraph text-center lg:text-left"
							/>
							<Link
								href={`${buttonLink?.url}`}
								...
								className={
									buttonLink?.url ? "group w-fit hidden lg:block" : "hidden"
								}
							>
						...
						<div className="flex flex-col lg:flex-row gap-8 items-center justify-center lg:gap-12 lg:justify-start">
							...
							>
								<div className="flex flex-shrink-0 mr-5 items-center justify-center p-1 w-10 h-10 bg-primary-default rounded-full">
									<svg
										viewBox="0 0 24 24"
										fill="none"
										className="w-5 h-5"
					...
					>
						<Form className="py-6 px-6 sm:px-10 md:px-12 xl:mr-8 w-full bg-primary-default max-w-full lg:max-w-md xl:max-w-xl">
							{loading ? (
								...
								>
									<h3 className="text-xl font-semibold uppercase font-Inter text-white">
										Sending Message...
									</h3>
								</motion.div>
							) : messageSent ? (
								<motion.div
									...
									className="flex items-center justify-center my-4 mb-8 gap-x-2"
								>
									<h3 className="text-xl font-semibold text-center uppercase font-Inter text-white">
										Message Sent!
									</h3>
								</motion.div>
							) : errorMessage ? (
								...
								>
									<motion.h3
										...
										whileInView={fadeInUp}
										viewport={{once: true}}
										className="my-3 max-w-xl mx-auto xl:mx-0 uppercase font-Inter text-white text-center lg:text-left font-semibold text-lg md:text-lg"
									>
										Transform your next project with ease!
									</motion.h3>
								</motion.div>
							)}
							...
							>
								<div className="flex flex-col md:flex-row gap-4">
									...
									>
										...
										<Field
											...
											className="px-4 py-3 w-full text-tiny md:text-base text-primary-default placeholder-black bg-white bg-opacity-90 outline-none border-[1px] border-primary-default active:border-primary-default focus:border-primary-default focus:ring-[1px] focus:ring-primary-default"
										/>
									</motion.div>
									<motion.div
										initial={initial}
								...
								>
									...
									<textarea
										...
										className="p-4 w-full h-32 text-tiny md:text-base text-primary-default placeholder-black bg-white bg-opacity-90 outline-none border-[1px] border-primary-default active:border-primary-default focus:border-primary-default resize-none focus:ring-[1px] focus:ring-primary-default"
									/>
								</motion.div>
								<motion.div
									initial={initial}
								...
								>
									...
									>
										<span className="tracking-widest uppercase font-Inter text-sm">
											{loading
												? "Sending Message..."
												: messageSent
												? "Message Sent!"
