			...
			>
				<div className="flex flex-col lg:flex-row items-center justify-between px-4 py-10 lg:py-5 lg:px-0 lg:container mx-auto gap-10 lg:gap-20">
					...
					>
						<Title
							content={paragraph}
							tailwindStyling="title mb-3 lg:mb-0 text-primary-default uppercase font-semibold font-Inter leading-tight text-center lg:text-left text-lg sm:text-xl lg:text-4xl"
						/>
					</motion.div>
					<motion.div
						viewport={{once: true}}
