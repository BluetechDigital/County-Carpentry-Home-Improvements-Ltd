		...
		<div className="bg-white container p-0 mx-auto flex flex-col px-4">
			...
			>
				<motion.h3
					...
					className={
						title
							? "my-3 max-w-xl mx-auto uppercase text-primary-default text-center font-semibold text-lg md:text-xl"
							: "hidden"
					}
				>
					{title}
				...
				<Paragraph
					...
					tailwindStyling={
						paragraph
							? `mb-10 mx-auto text-primary-default leading-[1.75rem] text-base text-center ${
									displayParagraph
