...
const Pagination: FC<IPagination> = ({
	...
	const tailwindButtonStyling =
		"relative px-6 py-2 text-primary-default hover:text-white font-semibold tracking-widest text-tiny w-fit border-2 border-solid border-primary-default hover:bg-primary-default hover:border-primary-default transition-all ease-in-out duration-500 before:left-[15%]";
				...
				{totalPages > 1 && contentArray?.length > 0 ? (
					<>
						<div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 lg:gap-6">
							...
							<span className="text-center text-tiny font-semibold leading-tight text-primary-default">
