...
const NavbarContactInfoBanner: FC = () => {
	...
	return (
		<>
			<div className="hidden md:flex flex-row items-center justify-between gap-4 p-2 bg-lightGreyTwo">
				<div className="flex flex-row items-center gap-4">
					<h3 className="hidden xl:block font-medium uppercase text-tiny font-Inter text-primary-default">
						Need A Carpentry Expert?
					</h3>
					<div
						className={
					...
					>
						<div className="flex items-center justify-center w-8 h-8 rounded-full bg-primary-default sm:mr-1">
							<svg
								width="20"
								height="20"
								viewBox="0 0 20 20"
						...
						<h3 className="font-medium uppercase text-tiny font-Inter text-primary-default">
							Email us your questions:
						</h3>
						<Link
							className="font-medium text-tiny font-openSauceSansRegular text-primary-default hover:opacity-70"
					...
					>
						...
						<Link
							className="font-medium text-tiny tracking-tighter font-openSauceSansRegular text-primary-default hover:opacity-70"
				...
				<div className="flex flex-row items-center gap-2">
					<h3 className="hidden lg:block font-medium uppercase text-tiny font-Inter text-primary-default">
						Follow Us:
					</h3>
					<Link
