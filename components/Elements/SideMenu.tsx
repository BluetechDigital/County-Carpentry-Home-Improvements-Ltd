			...
			>
				<div className="relative flex flex-col w-full h-full px-6 py-6 overflow-x-hidden overflow-y-auto bg-white border-solid border-l-8 border-primary-default bg-cover bg-center bg-no-repeat">
					<div className="flex items-center justify-between mb-8">
						...
						>
							<Image
								...
								src="/img/logos/county-carpentry-home-improvements-ltd-logo.png"
										...
										{item?.node?.url === "/services" ? (
											...
											>
												<div className="py-4 flex flex-row justify-between items-center gap-2">
													<Link
														...
														className="leading-snug font-Inter uppercase text-primary-default text-tiny text-center hover:text-accent-two"
													>
														{item?.node?.label}
													</Link>
													<Image
																				...
																				<li
																					className={`${
																						index < 1
																							...
																							: "border-t-[0px]"
																					} hover:border-primary-default hover:bg-primary-default border-y-[1px] border-primary-default border-opacity-50 text-primary-default hover:text-white`}
																				>
																					<Link
																						onClick={toggleMenu}
																						href={`${item?.node?.url}`}
											...
											<li className="border-b-[1px] border-primary-default border-opacity-50">
												<Link
													...
													aria-label={`${item?.node?.label}`}
													className="block py-4 leading-snug font-Inter uppercase text-tiny text-primary-default hover:text-accent-two"
												>
													{item?.node?.label}
												</Link>
											</li>
					...
					<div className="mt-20">
						...
						>
							<h4 className="mb-5 text-medium font-Inter tracking-normal text-center uppercase md:text-left text-primary-default">
								Contact Links
							</h4>
							...
							<div className="flex flex-col xl:flex-row items-center justify-center w-auto gap-2 py-6 mb-10">
								...
								>
									...
									<Link
										className="font-medium text-tiny tracking-wide text-primary-default hover:text-accent-two"
								...
								>
									...
									<Link
										className="font-medium text-tiny tracking-wide text-primary-default hover:text-primary-two"
