			...
			<div className="flex flex-col">
				...
				>
					<motion.div
						...
						viewport={{once: true}}
						className="bg-primary-default group-hover:bg-accent-two relative px-4 py-6 lg:py-12 h-[250px] bg-center bg-no-repeat bg-cover transition-all duration-500 ease-in-out"
						style={{
					...
					>
						...
						>
							<div className="flex justify-end gap-4 mb-4">
								<h3 className="flex items-center justify-center font-semibold  text-white text-tiny uppercase pl-4 w-fit h-12 bg-accent-two hover:bg-primary-default">
									Read More
									<Image
										width={550}
										height={550}
				...
				<div className="px-4 py-6 flex flex-col">
					...
					<Link target="" href={slug ? `projects/${slug}` : `/`}>
						<motion.h3
							...
							whileInView={fadeInUp}
							viewport={{once: true}}
							className="text-center lg:text-left text-primary-default hover:text-accent-two uppercase text-paragraph my-3 font-semibold"
						>
							{title}
						</motion.h3>
					</Link>
					<Paragraph
						...
						tailwindStyling="text-primary-default text-base sm:text-tiny text-center lg:text-left"
					/>
				</div>
			</div>
		</>
