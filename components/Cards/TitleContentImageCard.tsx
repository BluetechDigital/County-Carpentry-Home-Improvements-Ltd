	...
	return (
		<>
			...
			>
				...
				<Title
					content={textTitle}
					tailwindStyling={`my-4 font-semibold text-paragraph text-center lg:text-left ${titleColor}`}
				/>
				<Paragraph
					content={paragraph}
					tailwindStyling={`text-paragraph text-center lg:text-left ${paragraphColor}`}
				/>
				<div
					className={
						bulletPoints
