...
const TestimonialsSlider: FC = () => {
	...
	return (
		<>
			<div
				className={
					styles.testimonialsSlider + ` px-0 py-4 overflow-x-hidden bg-white`
				}
			>
											...
											<div className="max-w-4xl mx-auto pb-28 lg:pb-0">
												<div className="lg:flex items-center justify-center">
														...
														<Image
															className={
																item?.node?.testimonialReview?.image?.sourceUrl
																	? "bg-lightGreyTwo mx-auto lg:mx-0 w-20 h-20 mb-6 object-cover object-center"
																	: "hidden"
															}
													...
													<Paragraph
														...
														tailwindStyling="max-w-full px-6 lg:px-0 sm:max-w-lg lg:max-w-md xl:max-w-xl mx-auto lg:mx-0 leading-7 text-paragraph text-darkGrey text-center lg:text-left"
													/>
												</div>
											</div>
										</SwiperSlide>
