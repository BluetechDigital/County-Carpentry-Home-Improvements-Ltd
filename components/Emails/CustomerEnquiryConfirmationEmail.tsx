	...
	return (
		<>
			<Html>
				<Head />
				<Preview>
					Thank You for Contacting County Carpentry & Home Improvements Ltd
				</Preview>
				<Body style={main}>
					<Container style={container}>
						...
						<Section style={content}>
							...
							<Text style={paragraph}>
								Thank you for reaching out to County Carpentry & Home
								Improvements Ltd regarding, &quot;
								{subject}&quot; and our {selectedServices} services. We have
							...
							<Text style={paragraph}>
								Thank you once again for considering County Carpentry & Home
								Improvements Ltd for your {selectedServices} needs. We look
								forward to the opportunity to work with you and transform your
								ideas to reality.
							</Text>
							...
							<Text style={paragraph}>
								...
								Director,
								<br />
								County Carpentry & Home Improvements Ltd
							</Text>
							<Text style={paragraph}>
								Tel:{" "}
								<Link
